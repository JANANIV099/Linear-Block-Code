...
add = err + rc
print(f"The correct codeword is : " + " " .join(map(str,add)))Attach the program
```
# Output 
![Screenshot 2025-04-27 204245](https://github.com/user-attachments/assets/4605cb0e-bb97-446a-bbd3-7895bf044e34)
![Screenshot 2025-04-27 204259](https://github.com/user-attachments/assets/1a2e0535-317d-4b16-9485-2deead0fa6e2)

# Results
```
Thus,Linear Block Code for the Given input is successfully verifiedAttach the output waveform
```
# Manual calculation
